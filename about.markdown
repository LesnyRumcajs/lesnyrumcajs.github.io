...
Writing payment terminal application from scratch (if you've been to Poland recently, you probably used it), hardening and upgrading cryptography in existing systems (spent more time with *OpenSSL* than I'm willing to admit) and developing micro-services (in **C++20** !) - that's my my professional bread and butter. Happy **Linux** user.
